...
4. Бот автоматически пытается найти LM Studio (localhost/127.0.0.1, популярные порты и `/v1`).
5. По умолчанию приоритетный адрес: `http://127.0.0.1:1234/v1`.

Если хочешь задать адрес вручную (необязательно):
